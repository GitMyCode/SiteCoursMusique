...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Professeurs.id'
        db.delete_column(u'core_professeurs', u'id')

        # Adding field 'Professeurs.photo'
        db.add_column(u'core_professeurs', 'photo',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['core.image_model'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'image_model.prof'
        db.delete_column(u'core_image_model', 'prof_id')

        # Adding field 'image_model.id'
        db.add_column(u'core_image_model', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Professeurs.id'
        db.add_column(u'core_professeurs', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True),
                      keep_default=False)
        ...
        # Adding field 'image_model.prof'
        db.add_column(u'core_image_model', 'prof',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['core.Professeurs'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'image_model.id'
        db.delete_column(u'core_image_model', u'id')
    ...
    models = {
        ...
        u'core.professeurs': {
            ...
            'photo': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.image_model']", 'unique': 'True', 'primary_key': 'True'}),
